            ...
            <div>
                ...
                <div className='w-[60%] '>
                    <form onSubmit={Handle_Submit} className='mt-7 bg-transparent border-2 border-black backdrop-blur-[2px] ' action="">
                        ...
                        <p className='text-center md:text-[1em] text-[.55em] py-2 text-blue-800'>Dont’t Have An Account ? <Link className='text-[1.1em] font-bold text-slate-950 hover:text-blue-500  underline ' to="/Register">Register</Link></p>
