...
const Categories = () => {
    ...
    return (
        <div>
            <h2 className='text-[1.6em] md:text-3xl font-bold py-8  text-[#d52c81] text-center'>Shop By Category</h2>
            <Tabs>
                
                <section className=' bg-[#fdbad3]'>
               <div className='md:w-[37%] w-[70%] mx-auto'>
                    <TabList>
                        <div className='flex'>
                        <Tab>All</Tab>
                        <Tab>Frozen Doll</Tab>
                        <Tab>Mickey Mouse Doll</Tab>
                        <Tab>Princess Doll</Tab>
                        <Tab>Pooh Doll</Tab>
                        </div>
                    </TabList>
                </div>
            ...
            <h2 className='text-black grid grid-cols-1 md:grid-cols-3 py-4 md:gap-11 gap-3 bg-[url("https://images.squarespace-cdn.com/content/v1/5fb43dd79d63ac327876d9d8/1659831123917-19QRZSXLHRBUNQMKJ021/top+view+of+flowers.jpg?format=2500w")] '>
                {Dolls.map(p1 => <section key={p1._id}>
